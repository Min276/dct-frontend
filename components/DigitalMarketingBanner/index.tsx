...
const DMBannerSection: FunctionComponent = () => {
  ...
  return (
    <Box className="flex justify-center items-center w-full h-[43vh] sm:h-[54vh] md:h-[60vh] bg-no-repeat bg-center bg-cover bg-blend-multiply !bg-slate-200 bg-[url('/assets/digitalMarketing/banner.svg')]">
      <AnimationFrame>
